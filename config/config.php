 ...
 * BASIC
 */
$config['site_title'] = 'Greater Orlando Linux Users Group';	// Site title
$config['base_url'] = 'http://golug.ddns.net/';					// Override base URL (e.g. http://example.com)
 ...
 * TIMEZONE
 */
$config['timezone'] = 'America/New_York';                 // Timezone may be required by your php install
